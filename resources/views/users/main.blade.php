				...
				<div class="container-fluid">
					<div class="menu-desktop-inner">
						...
						<nav class="main-menu">
							<ul>
								<li class="menu-item">
									<a href="index1.html" class="current">
									HOME
									</a>
									<ul class="sub-menu">
										<li><a href="index1.html">Homepages 1</a></li>
       		...
       		<div id="rev_slider_1" class="rev_slider fullscreenbanner" data-version="5.4.5">
	            <ul>
	                ...
	                <li data-transition="boxslide">
	                    ...
	                    <img src="images/hp-1-slide-bg-1.jpg" alt="slide-1" class="rev-slidebg">
	                ...
	                <li data-transition="boxslide">
	                    <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
	                    <img src="images/hp-1-slide-bg-2.jpg" alt="slide-2" class="rev-slidebg">
	                ...
	                <li data-transition="boxslide">
	                    <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
	                    <img src="images/hp-1-slide-bg-3.jpg" alt="slide-3" class="rev-slidebg">
					...
					<div class="row">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
							<div class="categories-detail lighting">
								<a href="shop-full-width.html" class="images"><img src="images/hp-1-categories-1.jpg" alt="Lighting"></a>
								<div class="product">
									<a href="shop-full-width.html">
										<span class="name">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
							<div class="categories-detail furniture">
								<a href="shop-full-width.html" class="images"><img src="images/hp-1-categories-2.jpg" alt="Furniture"></a>
								<div class="product">
									<a href="shop-full-width.html">
										<span class="name">
											<span class="line">- </span>
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
							<div class="categories-detail decoration">
								<a href="shop-full-width.html" class="images"><img src="images/hp-1-categories-3.jpg" alt="Decoration"></a>
								<div class="product">
									<a href="shop-full-width.html">
										<span class="name">
											<span class="line">- </span>
