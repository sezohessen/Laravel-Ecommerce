...
<body class="404-page">
	...
	<header class="header">
		<!-- Show Desktop Header -->
		<div class="show-desktop-header header-hp-1 header-404 style-header-hp-1 style-header-hp-5">
			<div id="js-navbar-fixed" class="menu-desktop">
				<div class="container-fluid">
					<div class="menu-desktop-inner">
						<!-- Logo -->
						<div class="logo">
							<a href="index1.html"><img src="{{asset('images/icons/logo-white.png')}}" alt="logo"></a>
						</div>
						<!-- Header Right -->
						<div class="header-right">
							...
							<div class="search-btn-wrap">
	                            <button class="search-btn" data-toggle="modal" data-target="#searchModal">
	                                <img src="{{asset('images/icons/header-icon-11.png')}}" alt="search">
	                            </button>
	                        </div>
							<!-- Cart -->
							<div class="site-header-cart">
								<div class="cart-contents">
									<img src="{{asset('images/icons/header-icon-22.png')}}" alt="cart">
								</div>
	...
	<div class="page-content">
		...
		<section class="page-not-found" style="background-image: url({{asset('images/page-not-found-bg.jpg')}})">
			<div class="page-detail">
				<div class="page-inner">
					<h2>Oops!</h2>
					<h2>Page not found!</h2>
					<p>Page you are looking for does not exits.</p>
					<a href="{{route('Ecommerce')}}" class="au-btn-white btn-small">Back to Home Page<i class="zmdi zmdi-arrow-right"></i></a>
				</div>
			</div>
		</section>
